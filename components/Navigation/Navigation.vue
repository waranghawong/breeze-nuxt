...
import AppLogo from '../../pages/assets/Icons/AppLogo.vue'
const { user, logout } = useAuth();
const open = ref(false);
</script>

<template>
  <nav class="bg-[#ff8100] border-b border-gray-100">
        ...
        <div class="flex">
          ...
          <div class="flex-shrink-0 flex">
            <NuxtLink href="/dashboard">
              ...
              <AppLogo  class="block h-10 w-auto fill-current text-gray-600"/>
            </NuxtLink>
          </div>
