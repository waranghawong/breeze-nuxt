...
const { insertPayment } = paymentAsync();

let form = reactive<PaymentProps>({
              ...
              <form @submit.prevent="submit">
                <div class="mb-6 grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <Input type="text" v-model:model-value="form.first_name" :errors="errors.first_name" id="first_name" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                          <p>
                            <small class="text-red-700 text-xs" v-if="errors.first_name">*{{errors.first_name[0]}}</small>
                          </p>
                    </div>

                      <div class="col-span-2 sm:col-span-1">
                        <Label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Middle Name*</label>
                        <Input type="text" v-model:model-value="form.middle_name" :errors="errors.middle_name" id="middle_name" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                      </div>

                      <div class="col-span-2 sm:col-span-1">
                        <Label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Last Name* </label>
                        <Input type="text" v-model:model-value="form.last_name" :errors="errors.last_name" id="last_name" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                      </div>

                      <div class="col-span-2 sm:col-span-1">
                        <Label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Email* </label>
                        <Input type="text" v-model:model-value="form.email" :errors="errors.email" id="email" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                      </div>

                      <div class="col-span-2 sm:col-span-1">
                        <Label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Phone Number* </label>
                        <Input type="text" v-model:model-value="form.contact_number" :errors="errors.contact_number" id="contact_number" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                      </div>
<!--       
                  <div class="col-span-2 sm:col-span-1">
                ...
                <button type="submit" :disabled="inProgress" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Pay now</button>
              </form>
                ...
                <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
                  <div class="space-y-2">
                    <dl class="flex items-center justify-between gap-4">
                      ...
                      <dd class="text-base font-medium text-gray-900 dark:text-white">Php {{ course?.price_before}}</dd>
                    </dl>
      
                    <dl class="flex items-center justify-between gap-4">
                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                      <dd class="text-base font-bold text-red-500">Php {{ ans(course?.price_before, course?.price_after) }}</dd>
                    </dl>
                  ...
                  <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                    ...
                    <dd class="text-base font-bold text-gray-900 dark:text-white">Php {{ course?.price_after }}</dd>
                  </dl>
                </div>
            ...
            <p class="mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8 lg:text-left">
              Payment processed by <a href="www.ancientrusherva.com" title="" class="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">ARVA</a>
              Philippines
            </p>
          </div>
        </div>
